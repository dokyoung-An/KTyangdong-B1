...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__75.logicBlock_size = function() {
			...
			if (me.__75.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me.__75.style.transition='width 0s, height 0s';
				if (me.__75.ggCurrentLogicStateSize == 0) {
					me.__75.style.width='100%';
					me.__75.style.height='9%';
					skin.updateSize(me.__75);
				}
				else {
					me.__75.style.width='100%';
					me.__75.style.height='95%';
					skin.updateSize(me.__75);
				}
			}
		}
		...
		hs='data:image/svg+xml;base64,';
		...
		me._text_1.ggUpdateText=function() {
			var params = [];
			var hs = player._("\uc790\uc591\ub3d9 \uc624\ud53c\uc2a4\ud154", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		me.__69.logicBlock_position = function() {
			...
			if (
				((player.getVariableValue('vis_minimap_button') == false))
			)
			{
		...
		me.__63.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('vis_move_button') == false))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		me.__55.onclick=function (e) {
			...
			if (
				(
					((player.getVariableValue('vis_furniture_button') == true)) && 
					((player._(me.ggUserdata.title) == "\uc8fc\ubc29\uac70\uc2e4"))
				)
			) {
		...
		me.__46.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('vis_info_button') == false))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'IgMCAwIDEgMTIgNGM3IDAgMTEgOCAxMSA4YTE4LjUgMTguNSAwIDAgMS0yLjE2IDMuMTltLTYuNzItMS4wN2EzIDMgMCAxIDEtNC4yNC00LjI0Ii8+CiA8bGluZSB4Mj0iMjMiIHgxPSIxIiB5MT0iMSIgeTI9IjIzIi8+Cjwvc3ZnPgo=';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'A5Ii8+CiA8bGluZSB4Mj0iMjEiIHgxPSIxMCIgeTE9IjE0IiB5Mj0iMyIvPgo8L3N2Zz4K';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me.__23.logicBlock_position = function() {
			...
			if (me.__23.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__23.ggCurrentLogicStatePosition == 0) {
					me.__23.style.left = 'calc(50% - (80% / 2))';
					me.__23.style.top = 'calc(50% - (80% / 2) + (0px / 2) + 75px)';
				}
				else {
					me.__23.style.left='calc(50% - ((80% + 0px) / 2) + 0px)';
					me.__23.style.top='calc(50% - ((80% + 0px) / 2) + 15px)';
				}
			}
		}
		...
		me.__20.appendChild(me._image_7);
		...
		me.__20.appendChild(me._text_5);
		me._rectangle_8.appendChild(me.__20);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
